...
We can make the code more robust by removing null values.
...
We use arr.ind and which() to find and remove the rows that have a zero in either of the first two columns.
...
sum(up.ind)
```
So, there are 250 up-regulated genes at greater than 2 fc level.
...
sum(down.ind)
```
So, there are 367 down-regulated genes at greater than 2 fc level.

> Q10. Do you trust these results? Why or why not?

While fold changes can be large, such as in this case, they may not always be statistically significant. We cannot yet conclude whether these results are significant.